...
const expectCode = (fn: () => unknown, code: string) => {
  try {
    ...
    expect((e as MachinaLayoutError).code).toBe(code);
  }
};
...
describe("guide frame runtime", () => {
  it("basic one-axis placement", () => {
    const rows: LayoutRow[] = [
      { id: "root", frame: { kind: "root" } },
      {
        id: "inspector",
        parent: "root",
        frame: { kind: "absolute", x: 300, y: 0, width: 100, height: 100 },
      },
      {
        id: "toolbar",
        parent: "root",
  ...
  it("vertical placement", () => {
    const rows: LayoutRow[] = [
      { id: "root", frame: { kind: "root" } },
      {
        id: "button",
        parent: "root",
        frame: { kind: "absolute", x: 0, y: 50, width: 50, height: 20 },
      },
      {
        id: "tip",
        parent: "root",
        frame: {
          kind: "guide",
          top: { ref: "button", edge: "bottom", offset: 6 },
          height: 64,
          left: 10,
          width: 200,
        },
  ...
  it("allows outside parent", () => {
    const rows: LayoutRow[] = [
      { id: "root", frame: { kind: "root" } },
      { id: "a", parent: "root", frame: { kind: "absolute", x: 0, y: 0, width: 50, height: 50 } },
      {
        id: "b",
        parent: "root",
        frame: {
          kind: "guide",
          left: { ref: "a", edge: "left", offset: -100 },
          width: 20,
          top: 0,
          height: 20,
        },
  ...
  it("target can appear later in order", () => {
    const rows: LayoutRow[] = [
      ...
      },
      {
        ...
        parent: "root",
        order: 1,
        frame: { kind: "absolute", x: 30, y: 0, width: 10, height: 10 },
      },
    ];
  ...
  it("tree/flatten and lerp preserve guide metadata", () => {
    const rowsA: LayoutRow[] = [
      { id: "root", frame: { kind: "root" } },
      {
        id: "n",
        parent: "root",
        frame: { kind: "anchor", left: 0, top: 0, width: 10, height: 10 },
      },
    ];
    const rowsB: LayoutRow[] = [
      { id: "root", frame: { kind: "root" } },
      { id: "n", parent: "root", frame: { kind: "guide", left: 0, top: 0, width: 10, height: 10 } },
    ];
    ...
    expect(lerpResolvedLayouts(resolveLayoutRows(rowsA, root), rb, 0.5).nodes.n.frame.kind).toBe(
      "guide",
    );
  });
});
