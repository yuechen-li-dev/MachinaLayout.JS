...
describe("grid arrange", () => {
  ...
  it("fill tracks: equal, weighted, mixed and no-fill trailing space", () => {
        ...
        [
          {
            id: "root",
            frame: { kind: "root" },
            arrange: { kind: "grid", columns, rows: [{ kind: "fixed", size: 10 }] },
          },
    ...
    expect(
      mk([{ kind: "fill" }, { kind: "fill" }, { kind: "fill" }]).map((n) => Math.round(n)),
    ).toEqual([100, 100, 100]);
    expect(
      mk([
        { kind: "fill", weight: 1 },
      ...
      () =>
        resolveLayoutRows(
          [
            ...
            { id: "child", parent: "root", frame: { kind: "cell", row: 0, col: 0 } },
          ],
          ...
          [
            {
              ...
              arrange: {
                kind: "grid",
                columns: [{ kind: "fixed", size: 1 }],
                rows: [{ kind: "fixed", size: 1 }],
              },
            },
            {
              id: "child",
          ...
          [
            {
              id: "root",
              frame: { kind: "root" },
              arrange: { kind: "grid", columns: [], rows: [{ kind: "fixed", size: 1 }] },
            },
          ],
          { x: 0, y: 0, width: 10, height: 10 },
        ),
      ...
      [
        {
          ...
          arrange: {
            kind: "grid",
            columns: [{ kind: "fixed", size: 50 }],
            rows: [{ kind: "fixed", size: 50 }],
          },
        },
