...
export const searchForm = H.httpAction({
    ...
    action: "/search",
    title: "Search",
    description: "This form submits a native browser GET request. The server response is normal page navigation.",
    submitLabel: "Search",
    fields: [
        {
            id: "q",
...
export const contactForm = H.httpAction({
    ...
    action: "/contact",
    title: "Contact",
    description: "This form submits a native browser POST request. Handling, persistence, and validation beyond HTML attributes belong to the server.",
    submitLabel: "Send",
    fields: [
        {
            id: "source",
