...
export type TableDiagnosticCode =
  ...
  | "InvalidTransitionTo"
  | "InvalidTransitionAction"
  | "MissingTemplateColumn"
  | "TemplateExpansionError"
  | "InvalidTemplateExpansion"
  ...
  | "InvalidTemplateTargetField"
  | "InvalidTemplatePayloadField"
  | "InvalidTemplateState"
  | "DuplicateTemplateTransitionKey"
  ...
  | "InvalidConceptFormControl"
  | "DuplicateConceptFormField"
  | "DuplicateConceptFormInputId"
  | "DuplicateConceptFormTestId"
  | "ConceptFormValueResolverError"
  | "ConceptFormDisabledResolverError"
  | "ConceptFormControlResolverError"
